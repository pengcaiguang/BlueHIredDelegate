...
+(void)getUploadTempImages:(NSArray*)imgArr andBlock:(UploadImageTempBlock)BlockInfo{
    ...
    [NetApiManager requestQueryGetQiniuParam:nil withHandle:^(BOOL isSuccess, id responseObject) {
        ...
        if (isSuccess) {
            ...
            fileName = [fileName stringByAppendingString:@"_Delegate_ios.jpg"];
...
//用户登录
+ (void)requestQueryGetLogin:(id)paramer
                  withHandle:(response)responseHandle{
    NSString * appendURLString = @"login/login";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
...
//查看个人中心资料
+ (void)requestQueryGetUserMater:(id)paramer
                      withHandle:(response)responseHandle{
    NSString * appendURLString = @"userMaterial/select";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
...
//修改个人中心资料
+ (void)requestQueryUpdateUserMater:(id)paramer
                      withHandle:(response)responseHandle{
    NSString * appendURLString = @"userMaterial/saveOrUpdate";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestProblemAddWithParam:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"platform/add_problem";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestGetWorkRecordList:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"work/get_work_record_list";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//添加招工記錄
+ (void)requestInsertWorkRecordList:(id)paramer
                      withHandle:(response)responseHandle{
    NSString * appendURLString = @"work/insert_work_record";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//删除修改招工记录
+ (void)requestUpdateWorkRecordList:(id)paramer
                         withHandle:(response)responseHandle{
    NSString * appendURLString = @"work/update_work_record";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//查询招工记录详情
+ (void)requestGetWorkRecord:(id)paramer
                         withHandle:(response)responseHandle{
    NSString * appendURLString = @"work/get_work_record";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//获取店员店主门店详情
+ (void)requestShopInfo:(id)paramer
                          withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/get_shop_info";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//查询门店申请记录
+ (void)requestQueryShopApply:(id)paramer
                      withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/get_shop_apply";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//提交门店申请
+ (void)requestQueryInsetShopApply:(id)paramer
                   withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/insert_shop_apply";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//企业推荐
+ (void)requestQueryJobInsertJob:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"job/insert_job";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestWorklistWithParam:(id)paramer
                      withHandle:(response)responseHandle{
    NSString * appendURLString = @"job/query_work_list";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestMechanismlistWithParam:(id)paramer
                           withHandle:(response)responseHandle{
    NSString * appendURLString = @"job/query_mechanismlist";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestWorkqueryWithDrawRecord:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"billrecord/query_withdrawrecord";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestQueryAccept_invite:(id)paramer
                       withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/accept_invite";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestQueryinviteshopUser:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/invite_shop_user";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypePost
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//店主获取所属店员列表
+ (void)requestQueryGetShopUser:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/get_shop_user_list";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//查询邀请店员记录列表
+ (void)requestQueryHandleShopUser:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/get_invite_list";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
//清空已处理的邀请信息
+ (void)requestQueryDeleteHandleShopUser:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/handle_shop_user";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestQueryShopWorkDetail:(id)paramer
                              withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/get_shop_work_detail";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestQuerydismissShopuser:(id)paramer
                        withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/dismiss_shop_user";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
...
+ (void)requestQueryGetStaffList:(id)paramer
                         withHandle:(response)responseHandle{
    NSString * appendURLString = @"shop/get_staff_list";
    NetRequestEnty * enty = [self createEntyWithAppendURLString:appendURLString
                                                withRequestEnty:RequestTypeGet
                                                      withParam:paramer
                                                     withHandle:responseHandle
